...
const Home = () => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://api.themoviedb.org/3/trending/movie/day?api_key=70b615d6c1721910135b6883c89ee447"
      )
      .then((res) => setTrending(res.data.results.slice(0, 8)));

    axios
      .get(
        "https://api.themoviedb.org/3/movie/upcoming?api_key=70b615d6c1721910135b6883c89ee447&language=en-US&page=1"
      )
